Attribute VB_Name = "modPropagandas"
Public Sub cadastro()
Dim ws As Worksheet
Dim obj As cNotas
Dim lRow As Long, x As Long
        
Set ws = Worksheets("PROPAGANDAS")
Set obj = New cNotas
...
lRow = ws.Cells(Rows.count, 2).End(xlUp).Offset(1, 0).Row
    ...
    For x = 2 To lRow - 1
        ...
        With obj
            ...
            .CadastroCategoria = "UTEIS_PROPAGANDA"
            .Procedure = "spNotas"
...
Sub ListarPropagandas()
Dim obj As cNotas
Set obj = New cNotas

Dim col As cNotas
Set col = obj.getNotas(carregarBanco, "vw_propagandas")
