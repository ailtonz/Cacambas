Attribute VB_Name = "modTransportador"
Public Sub cadastro()
Dim ws As Worksheet
Dim obj As cEntidades
Dim lRow As Long, x As Long
        
Set ws = Worksheets("TRANSPORTADOR")
...
For x = 2 To lRow - 1
    ...
    With obj
        ...
        .CadastroCategoria = "ADM_TRANSPORTADOR"
...
Set col = obj.getEntidades(carregarBanco, "vw_transportador")
