VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmObservacoes 
   Caption         =   "OBSERVAÇÕES"
   ClientHeight    =   6540
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   8610.001
   OleObjectBlob   =   "frmObservacoes.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "frmObservacoes"
...
Set obj = New cNotas
    ...
    With obj
        ...
        If Me.cmdSalvar.Caption = "EXCLUIR" Then
            .Titulo = CStr("")
        Else
            .Titulo = CStr(Me.cboTitulo.Value)
        End If
...
Set col = Prf.getNotasID(carregarBanco, sConsulta, sFK)
...
Private Sub carregarCampos()
    ...
    Me.cboTitulo.Value = Me.lstRegistros.Column(1)
